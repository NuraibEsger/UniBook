...
namespace UniBook.Migrations
{
    ...
    [Migration("20240212094221_initial_migr")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniBook.Entities.StudentTeacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UniBook.Entities.StudentTeacher", b =>
                {
                    b.HasOne("UniBook.Entities.Student", "Student")
            ...
            modelBuilder.Entity("UniBook.Entities.Subject", b =>
                {
                    b.HasOne("UniBook.Entities.Teacher", "Teacher")
                        .WithOne("Subjects")
                        .HasForeignKey("UniBook.Entities.Subject", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
